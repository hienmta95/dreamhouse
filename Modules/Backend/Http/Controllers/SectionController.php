    ...
    public function indexData(Request $request)
    {
        ...
        return DataTables::of($sections)
            ...
            ->addColumn('action', function($row) use($position) {
                return
                    '<form method="POST" action="'. route("backend.section.destroy", $row->id) .'" onsubmit="return confirm('."'Are you sure you want to delete this item?'".');">
