<header class="main-header">
    ...
    <a href="{{ route('backend.dashboard') }}" class="logo">
        ...
        <span class="logo-lg"> - Dreamhouse Admin - </span>
    </a>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer" style="background-color: #48677d">
                            ...
                            <div class="col-xs-12 text-center">
                                <a href="{{ route('backend.logout') }}" class="btn btn-default btn-flat" style="background-color: #ffffff; font-weight: 700;">Sign out</a>
                            </div>
                        </li>
                    </ul>
                </li>
