...
<ul class="breadcrumb">
    ...
    <li class="active">Dreamhouse admin</li>
</ul>
@endsection
@section('content')
<div class="sp-push-index">
    ...
    <div class="grid-view" id="w0">
        <div class="summary">
            <table class="table table-striped table-bordered table-style" id="user-table">
                <thead>
                    <tr>
...
<script>
    var table = $('#user-table').DataTable({
        ...
        ajax: '{!! route('backend.user.indexData') !!}',
        ...
        "initComplete": function () {
            $('#user-table_paginate').css({"float": "left"});
            ...
            this.api().columns().every(function (i) {
                if (i != 0 && i != 6 && i != 12) {
                    ...
                    $('#user-table thead tr th input').css({"width": "100%", "margin": "0px 0px 0px 0px"});
                }
            });
